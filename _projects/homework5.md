...
<vegachart schema-url="/assets/json/cars.json" style="width: 100%; cursor: default;" class="vega-embed" role="graphics-document" aria-roledescription="visualization" aria-label="Vega visualization"><canvas width="863" height="615" class="marks" style="width: 480px; height: 342px;"></canvas><form class="vega-bindings"></form></vegachart>
