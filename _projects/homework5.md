...
<vegachart schema-url="{{ site.baseurl }}/assets/json/building_construction_by_year.json" style="width: 100%"></vegachart>
...
<vegachart schema-url="{{ site.baseurl }}/assets/json/cumulative_growth.json" style="width: 100%"></vegachart>
